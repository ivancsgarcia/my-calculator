...
export default function App() {
  ...
  const nameClickHandler = (e) => {
    ...
    let name = "Ivan Christopher S. Garcia";
    setDisp(name);
  }

  return (
    <div className="App">
      <div className="CalcContainer"><h1>Calculator of <br /> Ivan Christopher S. Garcia <br /> - IT3A</h1>
        ...
        <div className="ButtonContainer">
          ...
          <CalcButton label={"*"} onClick={operatorClickHandler}/>
          <CalcButton label={"C"} onClick={clearClickHandler} buttonClassName={"clear"}/>
          <CalcButton label={0} onClick={numberClickHandler} buttonClassName={"CalcButtonNum"}/>
          <CalcButton label={"="} onClick={equalClickHandler}/>
          <CalcButton label={"÷"} onClick={operatorClickHandler}/>
        </div>
        <div className="Name">
          <CalcButton label={"GARCIA"} onClick={nameClickHandler} buttonClassName={"CalcButtonName"}/>
        </div>
      </div>
    </div>
  );
